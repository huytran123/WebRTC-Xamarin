...
namespace WebRTC.iOS
{
    internal class PeerConnectionFactoryNative : NativeObjectBase, IPeerConnectionFactory
    {
        ...
        PeerConnectionListenerProxy _peerConnectionListenerProxy;
        ...
        {
            _peerConnectionListenerProxy = new PeerConnectionListenerProxy(peerConnectionListener);
